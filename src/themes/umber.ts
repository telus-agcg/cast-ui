...
export const umberTheme = {
  ...
  styles: {
    primary: {
      ...
      badgeBackground: umberColors.primaryFaded,
    ...
    danger: {
      ...
      badgeBackground: umberColors.dangerFaded,
      badgeColor: umberColors.white,
      alertColor: umberColors.white,
    ...
    warning: {
      ...
      light: {
        ...
        badgeColor: umberColors.warningHover,
      },
  ...
  select: {
    ...
    highlightOptionBackgroundColor: umberColors.lt200,
    highlightOptionColor: umberColors.primary,
