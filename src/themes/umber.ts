...
export const theme = {
  ...
  styles: {
    primary: {
      ...
      badgeBackground: colors.primaryHover,
    ...
    secondary: {
      ...
      badgeBackground: colors.drk600,
      badgeColor: colors.white,
      alertColor: colors.white,
      alertBackground: colors.drk600,
      notificationColor: colors.white,
      notificationBackground: colors.drk600,
      light: {
        alertColor: colors.drk800,
    ...
    success: {
      ...
      badgeBackground: colors.successHover,
      badgeColor: colors.white,
      alertColor: colors.white,
