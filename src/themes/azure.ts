...
export const azureTheme = {
  ...
  styles: {
    primary: {
      ...
      badgeBackground: azureColors.primary,
    ...
    secondary: {
      ...
      badgeColor: azureColors.white,
      alertColor: azureColors.drk800,
      alertBackground: azureColors.secondary,
      notificationColor: azureColors.drk800,
      notificationBackground: azureColors.secondary,
      light: {
        alertColor: azureColors.drk800,
    ...
    success: {
      ...
      badgeBackground: azureColors.successFaded,
      badgeColor: azureColors.white,
      alertColor: azureColors.white,
