...
const SideNavbar = props => {
  ...
  return (
    <Router>
      ...
      >
        <SSideNavbar {...props} isOpen={sidebar}>
          {
            <>
        ...
        {secondarySidebar ? (
          ...
          >
            ...
            <SSecondarySideNavbarLabel>{currentActiveItem?.label}</SSecondarySideNavbarLabel>
            {currentActiveSubnav?.map((item, index) => {
              return <CollapsedSubMenu item={item} key={index} />;
            })}
          </SSecondarySideNavbar>
        ) : (
          ''
